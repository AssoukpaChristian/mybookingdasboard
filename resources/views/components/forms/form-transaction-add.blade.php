<div
    x-data = "{
        modal : null,
        init(){this.modal = new bootstrap.Modal($refs.modalAddTransaction)},
    ...
    x-ref = "modalAddTransaction"
    wire:ignore.self
    tabindex="-1"
    aria-labelledby="modalAddTransaction"
    aria-hidden="true">

    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Ajouter un libellé d'opération</h1>
