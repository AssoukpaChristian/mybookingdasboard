<div
    x-data = "{
        modal : null,
        init(){this.modal = new bootstrap.Modal($refs.modalAddPays)},
    ...
    wire:ignore.self
    tabindex="-1"
    aria-labelledby="modalAddPays"
    aria-hidden="true">

    <div class="modal-dialog modal-lg">
        <div class="modal-content" x-ref="formaddpays">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Ajouter un pays</h1>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-5">
                                                <h3 class="text-sm">Nouveau pays</h3>
                                                <h3 class="fs-6 fw-normal text-secondary m-0">Informations du pays</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <form wire:submit="add_pays()" action="" x-ref="formaddpays">
