<div
    x-data = "{
        modal : null,
        init(){this.modal = new bootstrap.Modal($refs.modalUpdateCommune)},
    ...
    class="modal fade"
    id="modalUpdateCommune"
    x-ref = "modalUpdateCommune"
    wire:ignore.self
    tabindex="-1"
    aria-labelledby="modalUpdateCommune"
    aria-hidden="true">
                        ...
                        <div class="card border-light-subtle shadow-sm">
                            <div class="row g-0">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <form wire:submit="update_commune()" action="" x-ref="formupdatecommune">
