<div
    ...
    x-data = "{
        modal : null,
        init(){this.modal = new bootstrap.Modal($refs.modalAddBooking)},
    ...
    class="modal fade"
    id="modalAddBooking"
    x-ref = "modalAddBooking"
    tabindex="-1"
    aria-labelledby="modalAddBooking"
    aria-hidden="true">

    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Ajouter un booking</h1>
                                        ...
                                        <form wire:submit="add_booking()">
                                            ...
                                            <div class="row gy-3 gy-md-4 overflow-hidden">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input  id= "montant" type="number" placeholder="montant" class="form-control" wire:model.blur="montant"  required/>
                                                ...
                                                <div class="col-12">
                                                    <label for="montant_paye" class="form-label">Paiement <span class="text-danger">*</span></label>
                                                    <input  id= "montant_paye" type="number" placeholder="Avance ou Paiement effectué" class="form-control" wire:model.blur="montant_paye" />
                                                    @error('montant_paye') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
