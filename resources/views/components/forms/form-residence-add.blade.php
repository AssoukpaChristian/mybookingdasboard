<div
    x-data = "{
        modal : null,
        init(){this.modal = new bootstrap.Modal($refs.modalAddResidence)},
    ...
    class="modal fade"
    id="modalAddResidence"
    x-ref = "modalAddResidence"
    wire:ignore.self
    tabindex="-1"
    aria-labelledby="modalAddResidence"
    aria-hidden="true">
                        ...
                        <div class="card border-light-subtle shadow-sm">
                            <div class="row g-0">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <form wire:submit="add_residence()">
