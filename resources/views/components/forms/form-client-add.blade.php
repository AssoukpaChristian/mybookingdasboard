<div
    x-data = "{
        modal : null,
        init(){this.modal = new bootstrap.Modal($refs.modalAddClient)},
    ...
    class="modal fade"
    id="modalAddClient"
    x-ref = "modalAddClient"
    wire:ignore.self
    tabindex="-1"
    aria-labelledby="modalAddClient"
    aria-hidden="true">
                        ...
                        <div class="card border-light-subtle shadow-sm">
                            <div class="row g-0">
                                <div class="col-12 col-md-6">
                                    <img class="img-fluid rounded-start w-100 h-100 object-fit-cover" loading="lazy" src="{{ asset('img/client_registration.jpg') }}" alt="client_registration Image">
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="card-body p-3 p-md-4 p-xl-5">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="mb-5">
                                                    <h3 class="text-sm">Nouveau client</h3>
                                                    <h3 class="fs-6 fw-normal text-secondary m-0">Informations du client</h3>
                                                </div>
                                            </div>
                                        </div>
                                        <form wire:submit="add_client()" action="" x-ref="formaddclient">
