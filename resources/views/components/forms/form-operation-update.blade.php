<div
    x-data = "{
        modal : null,
        init(){this.modal = new bootstrap.Modal($refs.modalUpdateOperation)},
    ...
    class="modal fade"
    id="modalUpdateOperation"
    x-ref = "modalUpdateOperation"
    wire:ignore.self
    tabindex="-1"
    aria-labelledby="modalUpdateOperation"
    aria-hidden="true">

    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Modifier une opération</h1>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-5">
                                                <h3 class="text-sm">Modifier une opération</h3>
                                                <h3 class="fs-6 fw-normal text-secondary m-0">Informations opération</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <form wire:submit="update_operation()">
                                        ...
                                        <div class="row gy-3 gy-md-4 overflow-hidden">
                                            ...
                                            <div
                                                ...
                                                x-data="{ operationdate: @entangle('operationdate').defer }"
                                                class="col-12"
                                                x-init="
                                                ...
                                                {{-- <input x-ref="operationdate" type="text" class="form-control" wire:model.blur="operationdate" required /> --}}
