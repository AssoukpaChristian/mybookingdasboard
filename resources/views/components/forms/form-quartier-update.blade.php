<div
    x-data = "{
        modal : null,
        init(){this.modal = new bootstrap.Modal($refs.modalUpdateQuartier)},
    ...
    class="modal fade"
    id="modalUpdateQuartier"
    x-ref = "modalUpdateQuartier"
    wire:ignore.self
    tabindex="-1"
    aria-labelledby="modalUpdateQuartier"
    aria-hidden="true">

    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Modifier un quartier</h1>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-5">
                                                <h3 class="text-sm">Modifier le quartier</h3>
                                                <h3 class="fs-6 fw-normal text-secondary m-0">Informations du quartier</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <form wire:submit="update_quartier()">
